...
export const getParticipantsOptions = (): ChecklistElement['options'] => {
...
export const getFeccParticipantsOptions = (): ChecklistElement['options'] => {
  const participants = getParticipants()
  .filter((participant) => participant.canFecc)
  .map((participant) => ({
    id: participant.uuid,
    label: getCleanDisplayName(participant)
  }));
